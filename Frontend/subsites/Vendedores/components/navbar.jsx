...
const Navbar = () => {
  ...
  const menuItems = [
    { icon: <Home size={22} />, label: 'Inicio', view: 'Home', path: '/Vendedores' },
    { icon: <Inbox size={22} />, label: 'Modificar Domicilio ', view: 'ModificarDomicilio', path: '/Vendedores/marcar-domicilio' },
    { icon: <Inbox size={22} />, label: 'Descargar Factura ', view: 'descargarfactura', path: '/Vendedores/descargar-factura' },
    { icon: <Inbox size={22} />, label: 'Notas ', view: 'Notas', path: '/Vendedores/notas' },
  ];
          ...
          {isSettingsOpen && (
            <ul className="dropdown-menu">
              ...
              <li
                ...
                onClick={() => navigate('/Vendedores/historial')}
              >
                Historial
              </li>
